...
export class SectorService {
    ...
    private resourceUrl =  SERVER_API_URL + 'stockservices/api/sectors';
    ...
    find(id: number): Observable<EntityResponseType> {
        return this.http.get<Sector>(`${this.resourceUrl}/sector-infos/${id}`, { observe: 'response'})
            .map((res: EntityResponseType) => this.convertResponse(res));
    }
    ...
    getMostDiscussedCompany(sector: any): Observable<EntityResponseType> {
        return this.http.get<any>(SERVER_API_URL + 'sentimentservices/api/getMostDiscussedCompany/' + sector, { observe: 'response' });
    }
    getHotTopic(sector: string): Observable<HttpResponse<any>> {
        return this.http.get<any>(SERVER_API_URL + 'sentimentservices/api/getHotTopicsBySector/' + sector, { observe: 'response' });
    }
