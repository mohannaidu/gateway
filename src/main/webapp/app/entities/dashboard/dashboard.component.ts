...
import { Sector } from '../../../../webapp/app/entities/sector';
import { Stock } from '../../../../webapp/app/entities/stock/';
...
export class DashboardComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.dashboardService.get(this.newDate).toPromise().then((response) => {console.log('this.SectorData', response);
